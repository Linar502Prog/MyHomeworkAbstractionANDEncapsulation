...
int main() {
	...
	std::ifstream in("C:\\Users\\Ëèíàð\\OneDrive\\Desktop\\Íîâûé òåêñòîâûé äîêóìåíò (3).txt");
	if (!in.is_open()) {
		...
		in.close();
		std::ofstream out("C:\\Users\\Ëèíàð\\OneDrive\\Desktop\\Íîâûé òåêñòîâûé äîêóìåíò (4).txt");
		if (!out.is_open()) {
